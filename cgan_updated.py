...
print("Test numbers:{}".format(numbers))
...
for epoch in range(opt.n_epochs):
    for i, (imgs, labels) in enumerate(dataloader):
        ...
        if i%opt.n_generator==0:
            ...
            gen_labels = Variable(FloatTensor(digit_embeddings[np.random.choice(train_numbers, batch_size)]))
        ...
        if opt.loss == 'Wasserstein':
            #clip discriminator values
